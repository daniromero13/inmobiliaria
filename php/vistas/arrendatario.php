...
<body>
    ...
    <nav class="nav-arrendatario mb-4">
        <a href="../arrendatario/mis_propiedades.php"><i class="bi bi-house-door"></i>Propiedades Arrendadas</a>
        <a href="../arrendatario/mis_contratos.php"><i class="bi bi-file-earmark-text"></i>Mis Contratos</a>
        <a href="../arrendatario/mis_pagos.php"><i class="bi bi-clock-history"></i>Historial de Pagos</a>
        <a href="../arrendatario/subir_comprobante.php"><i class="bi bi-upload"></i>Subir Comprobante</a>
        <a href="../arrendatario/reportes_arrendatario.php"><i class="bi bi-bar-chart"></i>Reportes</a>
    ...
    <div class="container">
        <div class="main-card shadow text-center">
            <div class="card-title">Panel de arrendatario</div>
            <div class="card-text mb-4">Accede a tus contratos, pagos, comprobantes y propiedades desde el menú superior.</div>
        </div>
    </div>
</body>
</html>
